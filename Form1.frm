...
Begin VB.Form Form1 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(11)=   "tmrCheck"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "tmrMove"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "Option2"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "Check6"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "Check7"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "Timer7"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "Timer8"
      ...
      Tab(1).Control(2)=   "Drive1"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "File1"
...
File2.path = App.path
File2.Pattern = "*.hwnd"
If File2.ListCount = 0 And File2.List(0) <> "" Then
Combo2.AddItem File2.List(0)
Exit Sub
End If
For v = 0 To File1.ListCount - 1
Combo2.AddItem File2.List(v)
Next v
End Sub

Private Sub File1_Click()
If File1.FileName <> "" Then
Text1.Text = GetFile(Replace(Dir1.path & "\" & File1.FileName, "\\", "\"))
End If
End Sub
...
i = FreeFile
ReDim BB(FileLen(txtpath) - 1)
Open txtpath For Binary As #i
Get #i, , BB
Close #i
...
If Label1.Caption <> "" Then
If Combo2.Text <> "" And Check3.Value = Checked Then
MsgBox "定向发送目标文件不能为空", , "启动失败"
End If
    Readtxt (Label1.Caption)
...
Case 2
    ...
    End If
Case 3
    StatusBar1.SimpleText = "请按下Ctrl+Alt+" & key & "启动打字"
    If GetAsyncKeyState(vbKeyControl) And GetAsyncKeyState(vbKeyMenu) And GetAsyncKeyState(Asc(key)) Then
    StatusBar1.SimpleText = "开始打字"
    status = 5
    End If
Case 4
